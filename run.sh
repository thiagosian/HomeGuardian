...
export BACKUP_LOVELACE=$(bashio::config 'backup_lovelace')
export PARSE_BLUEPRINTS=$(bashio::config 'parse_blueprints')
export PARSE_VOICE_ASSISTANT=$(bashio::config 'parse_voice_assistant')
